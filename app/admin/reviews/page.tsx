    ...
    <div className="space-y-6 sm:space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-gray-200/80 shadow-xs">
          ...
          <div className="text-[11px] text-gray-400 mt-1">NFC taps converted to reviews</div>
        </div>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-gray-200/80 shadow-xs">
          ...
          <div className="text-[11px] text-gray-400 mt-1">Platform-wide satisfaction</div>
        </div>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-gray-200/80 shadow-xs">
          ...
          <div className="text-2xl sm:text-3xl font-black text-emerald-600">{conversionRate}%</div>
          <div className="text-[11px] text-gray-400 mt-1">{googleConverted} pasted directly to Google</div>
        </div>
      </div>

      {/* Filter Toolbar */}
      <div className="bg-white p-4 sm:p-5 rounded-3xl border border-gray-200/80 shadow-xs space-y-3 sm:space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <select
              ...
              className="w-full md:w-auto px-3 py-2 bg-gray-50 border border-gray-200 rounded-xl text-xs font-bold text-gray-800 focus:outline-none focus:border-black cursor-pointer"
            >
          ...
          {/* Rating Filters */}
          <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-xl text-xs font-bold overflow-x-auto w-full md:w-auto">
            {[
            ...
            {filteredReviews.map((rev) => {
              ...
              return (
                <div key={rev.id} className="py-4 space-y-2.5">
                  ...
                  {rev.feedback && (
                    <div className="p-3 bg-gray-50/80 rounded-2xl text-xs text-gray-700 border border-gray-100">
                      <strong className="text-slate-500 font-bold block text-[10px] mb-0.5 uppercase tracking-wider">
                  ...
                  {rev.review_text && (
                    <div className="p-3.5 bg-amber-50/60 border border-amber-200/80 rounded-2xl text-xs text-gray-900 flex items-start gap-2.5 shadow-xs">
                      <Sparkles className="w-4 h-4 text-amber-600 flex-shrink-0 mt-0.5" />
                      <div className="space-y-0.5 min-w-0">
                        <strong className="text-[10px] text-amber-800 font-extrabold block uppercase tracking-wider">
                          Final Polished Review Text:
                        </strong>
